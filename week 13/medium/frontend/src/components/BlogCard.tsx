  ...
  return (
    <article>
      <header className="inline-flex items-center justify-center gap-1 text-sm text-gray-600 mb-2">
        ...
        <div className="font-medium font-sans text-gray-700 mx-1 capitalize">{authorName}</div>
        <time className="font-normal font-sans text-gray-500" dateTime={datePublished}>{datePublished}</time>
      </header>
      ...
      <footer className="text-sm text-gray-500 mt-8">{readMinutes} min read</footer>
